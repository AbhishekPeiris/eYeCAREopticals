            ...
            {loading ? (
                ...
                <div>
                    ...
                    <div class="container py-5">
                        <div class="row align-items-center mb-5">
                            <div class="col-lg-6 order-2 order-lg-1">
                                <h3 class="font-weight-light" style={{marginLeft:"30px"}}><strong>You can get any model of Spectacles from us</strong></h3>
                                <div style={{textAlign:"justify",width:"580px"}}><p class="text-muted mb-4" style={{marginLeft:"30px",fontSize:"14px"}}>Discover a diverse collection of eyewear at our optical system, featuring renowned brands like Ray-Ban, Che, Chanel, and Tens. From iconic styles to trendy designs, we offer a spectrum of choices, ensuring you find the perfect pair of spectacles that align with your fashion preferences and optical needs.</p></div>
                            </div>
                    ...
                    <div class="container py-5">
                        <div class="row align-items-center mb-5">
                            <div class="col-lg-6 order-2 order-lg-1">
                                <img src={Rayban} alt="" class="img-fluid" style={{marginLeft:"30px"}}/>
                            </div>
                            <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2" data-aos="zoom-in">
                                ...
                                <div style={{textAlign:"justify",width:"450px",fontSize:"14px"}}><p class="text-muted mb-4"> Ray-Ban glasses are fitted with prescription lenses made from high-quality glass or plastic to ensure your eyes have maximum eye protection. Ray-Ban lenses, whether glass or plastic, can also have various lens coatings to add when you purchase prescription eyeglasses.</p></div>
                    ...
                    <div class="container py-5">
                        <div class="row align-items-center mb-5">
                            <div class="col-lg-4 order-2 order-lg-1" data-aos="zoom-in" style={{marginLeft:"30px"}}>
                    ...
                    <div class="container py-5">
                        <div class="row align-items-center mb-5">
                            <div class="col-lg-6 order-2 order-lg-1">
                                <img src={Chanel} alt="" class="img-fluid" style={{marginLeft:"30px"}}/>
                            </div>
                            <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2" data-aos="zoom-in" >
