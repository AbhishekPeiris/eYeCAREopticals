        ...
        <form className="form mb-5 mt-5" onSubmit={addDoctorDetails}>
          ...
          <div className='flex-container'>
            <div className="input-container">
              ...
              <input type="number" placeholder="Enter Doctor Fee" value={doctorFee} onChange={(e) => setDoctorFee(e.target.value)} />
            </div>
            <div className="input-container">
          ...
          <div className='flex-container'>
            ...
            <div className="input-container">
              ...
              <input type="text" placeholder="Enter Specialty" value={specialty} onChange={(e) => setSpecialty(e.target.value)} />
            </div>
          </div>
          <div className='flex-container'>
            <div className="input-container">
