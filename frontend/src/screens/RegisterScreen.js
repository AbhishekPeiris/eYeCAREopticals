                        ...
                        <div className="container h-100">
                            <div className="row d-flex justify-content-left align-items-left h-100 mt-5 mb-5">
                                <div className="col-12 col-md-8 col-lg-6">
                                    <div className="cardregister" style={{ borderRadius: "15px", border: "3px solid #f5e9db" }}>
                                        <div className="card-body p-4">
                                            ...
                                            <form onSubmit={UserRegister}>
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" id="firstName" className="form-control inputregister" placeholder='Enter first name' value={firstname} required 
                                                        onChange={(e) => {
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" id="lastName" className="form-control inputregister" placeholder='Enter last name' value={lastname} required 
                                                        onChange={(e) => {
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="date" id="dob" className="form-control inputregister" value={dob} required 
                                                        onChange={(e) => {
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <textarea id="address" className="form-control inputregister" style={{ width: '100%', minHeight: '50px', maxHeight: "100px", backgroundColor: "white" }} placeholder="Enter address" value={address} required
                                                        onChange={(e) => {
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="email" id="email" className="form-control inputregister" placeholder='Enter email' value={email} required 
                                                        onChange={(e) => {
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type={passwordVisible ? 'text' : 'password'} id="password" className="form-control inputregister" placeholder='Enter password' value={password} required 
                                                        onChange={(e) => {
                                                ...
                                                <div className="mb-3 cp">
                                                    ...
                                                    <input type={confirmPasswordVisible ? 'text' : 'password'} id="confirmPassword" className="form-control inputregister" placeholder='Enter confirm' value={passwordConfirmation} required 
                                                        onChange={(e) => {
                                                ...
                                                <div className="d-flex justify-content-center">
                                                    <button type="submit" className="btn btn-success btn-block btn-lg text-body"><span style={{color:"white"}}>Register</span></button>
                                                </div>
