...
function UpdateRepairmentDetails() {
    ...
    async function fetchRepDetails() {
      try {
        const response = await axios.post(
          `http://localhost:5000/api/repairment/${repID}`
        );
  ...
  async function UpdateRepairmentDetails(e) {
    ...
    try {
      const data = (
        await axios.put(
          `http://localhost:5000/api/repairment/editrepairment/${repID}`,
          updateRepDetails
        )
      ).data;
    ...
    <div className="thathsarani">
      ...
      <div style={{ marginLeft: "300px" }}>
        <form onSubmit={UpdateRepairmentDetails}>
          ...
          <div className="col-md-3">
            <div class="form mb-5 mt-5">
              <div className="addrfulltable11" style={{position:"relative",marginLeft:"500px"}}>
                <h4 className="addrhedder">
